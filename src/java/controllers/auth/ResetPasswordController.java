...
public class ResetPasswordController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.setAttribute("email", email2);
            request.getRequestDispatcher("/views/common/Resetchange.jsp").forward(request, response);
        } else {
...
//      request.getRequestDispatcher("/views/common/ResetPassword.jsp").forward(request, response);
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (udb.getUserEmail(mail1)) {
            ...
            MailValidation.send(mail1, subject, message, "thainv35nb@gmail.com", "uekekfcciswhkyfm");
