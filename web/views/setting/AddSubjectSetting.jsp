        ...
        <div class="wrapper d-flex flex-column min-vh-100 bg-light">
            ...
            <div class="body flex-grow-1 px-3">
                <div class="container-lg">
                    ...
                    <!-- Table Content-->
                    <form id="__form">
                        <input class="form-control" type="hidden" name="action" value="add" readonly="">
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <select id="subject_id" class="form-control" name="sub_id">
                                        ...
                                        <select id="type" class="form-control" name="type">
                                            <c:forEach var="type1" items="${type}">
                                                <c:forEach var="setting1" items="${setting}">
                                                    <c:if test="${type1 == setting1.getType_id()}">
                                                        <option value="${setting1.getSetting_id()}">${setting1.getSetting_title()}</option>
                                                    </c:if>
                                                </c:forEach>
                                            </c:forEach>
                                        </select>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputTitle" name="title" rows="3"></input>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" id="inputTitle" name="value" rows="3"></input>
                                        <div class="invalid-feedback">
                                            Value is not null.
                                        </div>
                                    </div>
                                ...
                                <div class="row gx-3 mb-3">
                                    <div class="col-md-12">
                                        ...
                                        <input class="form-control" type="number" id="order" min="1" max="10" required="" name="Display">
                                        <div class="invalid-feedback">
                                            Value is not null.
                                        </div>
                                    </div>
                                        ...
                                        function save_change() {
                                            ...
                                            $.ajax({
                                                ...
                                                success: function (data) {
                                                    if (data == "success") {
                                                        $(wrapper).append(
                                                                '<div class="snackbar show" role="alert"><i class="fa fa-check-circle text-success"></i>Add Subject Setting successfully</div>'
                                                                );
