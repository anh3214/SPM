...
<html lang="en">
    ...
    <head>
        ...
        <title>Project Manager - User Detail</title>
        ...
        <div class="wrapper d-flex flex-column min-vh-100 bg-light">
                ...
                <div class="container-lg">
                    <div class="row">
                        ...
                        <div class="col-xl-8">
                            ...
                            <div class="card mb-4">
                                <div class="card-header">Account Details - ID: ${current_user.getUser_id()}</div>
                                ...
                                <div class="card-body">
                                    <form id="__form">
                                        ...
                                        <div class="row gx-3 mb-3">
                                            <!-- Form Group (Role)-->
                                            <div class="col-md-6">
                                                <label class="small mb-1" for="inputRoleId">Role (*)</label>
                                                <select class="form-select" id="inputRoleId" name="role_id" aria-label="Select Role">
          
                                                    <option value="1" ${current_user.getRole_id() == 1 ? "selected" : ""}>Admin</option>
                                                    <option value="2" ${current_user.getRole_id() == 2 ? "selected" : ""}>Author</option>
                                                    <option value="3" ${current_user.getRole_id() == 3 ? "selected" : ""}>Teacher</option>
                                                    <option value="4" ${current_user.getRole_id() == 4 ? "selected" : ""}>Student</option>
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-control">
                                                    ...
                                                    <c:if test = '${current_user.getStatus() == 1}'>
                                                        <script>
                                                            document.getElementById("status1").checked = true;
                                                        </script>
                                                    </c:if>

                                                    <c:if test = '${current_user.getStatus() == 0}'>
                                                        <script>
            ...
            <script>
                ...
                function save_change() {
                    ...
                    $.ajax({
                        url: 'edit_user',
                        data: $("#__form").serialize() + "&uid=" + ${current_user.getUser_id()},
                        cache: false,
                        processData: false,
                        type: 'POST',
                    ...
                    if (/^image/.test(files[0].type)) {
                        ...
                        reader.onloadend = function () {
                            ...
                            setTimeout(() => {
                                ...
                                $.ajax({
                                    url: 'profile/avatar?uid=' + ${current_user.getUser_id()},
                                    data: dat,
                                    cache: false,
                                    contentType: false,
                                    processData: false,
