                ...
                <div class="container-fluid">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb my-0 ms-2">
                            ...
                            <li class="breadcrumb-item active"><span>Users List</span></li>
                        </ol>
                    </nav>
                </div>
            </header>
                            ...
                            <div class="card-body">
                                ...
                                <div class="table-responsive" id="__rxz">
                                    <div class="input-group">
                                        <button class="btn btn-outline-secondary dropdown-toggle" type="button" data-coreui-toggle="dropdown" aria-expanded="false">Role</button>
                                        <ul class="dropdown-menu">
                                            <li><a class="dropdown-item" onclick="urlSearch('role', -1)">All</a></li>
                                            <li><a class="dropdown-item" onclick="urlSearch('role', 1)">Admin</a></li>
                                            <li><a class="dropdown-item" onclick="urlSearch('role', 2)">Author</a></li>
                                            <li><a class="dropdown-item" onclick="urlSearch('role', 3)">Teacher</a></li>
                                            <li><a class="dropdown-item" onclick="urlSearch('role', 4)">Student</a></li>
                                        </ul>
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end">
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" id="byNameCheckSearch" type="checkbox" checked250>
                                                    <label class="form-check-label" for="flexCheckDefault">By Name</label>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="form-check">
                                                    <input class="form-check-input" id="byEmailCheckSearch" type="checkbox">
                                                    <label class="form-check-label" for="flexCheckDefault">By Email</label>
                                                </div>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <table class="table border mb-0">
                                        ...
                                        <tbody>
                                            <c:forEach items="${dummies}" var="dummy">
                                                <tr>
                                                    <td>${dummy.getUser_id()}</td>
                                                    <td class="text-center">
                                                        <div class="avatar"><img class="avatar-img" src="${dummy.getAvatar_link()}" alt="@"></div>
                                                    </td>
                                                    <td><c:out value = "${dummy.getFull_name()}"/></td>
                                                    ...
                                                    <td>
                                                        ${dummy.getDate_of_birth()}
                                                    </td>
                                                    <td>
                                                        +${dummy.getMobile()}
                                                    </td>
                                                    <td>
                                                        <span class="badge me-1 rounded-pill bg-danger">${dummy.getRole_id() == 1 ? "Admin" : dummy.getRole_id() == 2 ? "Author" : dummy.getRole_id() == 3 ? "Teacher" : "Student"}</span>
                                                    </td>
                                                    <td class="text-center">
                                                        <div class="form-check form-switch">
                                                            <input class="form-check-input" name="sw" id="sw__${dummy.getUser_id()}" fe="${dummy.getEmail()}" type="checkbox" ${dummy.getStatus() == 1 ? "checked" : ""}>

                                                        </div>
                                                    </td>
                                                    <td>
                                                        <a href="edit_user?uid=${dummy.getUser_id()}" class="btn btn-primary rounded-pill btn-sm" type="button">Edit</a>
                                                    </td>
        ...
        <script>
            $(document).ready(function () {
                                    ...
                                    if (url.searchParams.get("name") != null)
                                        $("#inputSearch").val(decodeURI(url.searchParams.get("name")));
                                                ...
                                                function updateStatus(uid, status) {
                                                    ...
                                                    $.ajax({
                                                        url: 'users',
                                                        data: "action=update_status&uid=" + uid + "&status=" + status,
                                                        cache: false,
                                                        processData: false,
                                                        type: 'POST',
